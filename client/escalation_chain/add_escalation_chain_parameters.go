...
func (o *AddEscalationChainParams) WithBody(body *models.EscalationChain) *AddEscalationChainParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add escalation chain params
func (o *AddEscalationChainParams) SetBody(body *models.EscalationChain) {
	o.Body = body
}
