...
func (o *UpdateDeviceGroupClusterAlertConfByIDParams) WithBody(body *models.DeviceGroupClusterAlertConf) *UpdateDeviceGroupClusterAlertConfByIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update device group cluster alert conf by Id params
func (o *UpdateDeviceGroupClusterAlertConfByIDParams) SetBody(body *models.DeviceGroupClusterAlertConf) {
	o.Body = body
}
