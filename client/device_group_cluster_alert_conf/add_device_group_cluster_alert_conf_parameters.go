...
func (o *AddDeviceGroupClusterAlertConfParams) WithBody(body *models.DeviceGroupClusterAlertConf) *AddDeviceGroupClusterAlertConfParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add device group cluster alert conf params
func (o *AddDeviceGroupClusterAlertConfParams) SetBody(body *models.DeviceGroupClusterAlertConf) {
	o.Body = body
}
