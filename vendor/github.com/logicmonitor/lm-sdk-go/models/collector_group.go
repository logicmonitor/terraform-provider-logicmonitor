...
type CollectorGroup struct {
	...
	AutoBalanceDeviceCountThreshold int32 `json:"autoBalanceDeviceCountThreshold,omitempty"`

	// auto balance instance count threshold
	...
	// mismatch verison
	MismatchVerison bool `json:"mismatchVerison,omitempty"`
