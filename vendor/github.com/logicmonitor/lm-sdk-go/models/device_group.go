...
type DeviceGroup struct {
	...
	// The id of the default Load Balanced Collector Group assigned to the device group
	DefaultLoadBalanceCollectorGroupID int32 `json:"defaultLoadBalanceCollectorGroupId,omitempty"`
