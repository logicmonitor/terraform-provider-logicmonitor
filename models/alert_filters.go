...
type AlertFilters struct {
	...
	// Filter by dependency role
	DependencyRole string `json:"dependencyRole,omitempty"`

	// Filter by dependency routing state
	...
	IsEscalation string `json:"isEscalation,omitempty"`

	// Filter by historical SDT status
