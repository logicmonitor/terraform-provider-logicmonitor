...
func (m *AlertWidget) SupportKeyWord() string {
	return m.supportKeyWordField
}

// SetSupportKeyWord sets the support key word of this subtype
func (m *AlertWidget) SetSupportKeyWord(val string) {
...
func (m *AlertWidget) UnmarshalJSON(raw []byte) error {
	...
	result.RefreshFrequency = data.RefreshFrequency
	result.SupportCustomProperty = data.SupportCustomProperty
	result.WidgetColorSchema = data.WidgetColorSchema
...
func (m AlertWidget) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		WidgetColorSchema: m.WidgetColorSchema,
	})
	if err != nil {
		return nil, err
	}
