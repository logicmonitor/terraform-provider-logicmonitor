...
//
// swagger:model CollectorAttribute
...
func (m *CollectorAttribute) validateName(formats strfmt.Registry) error {
...
func (m *CollectorAttribute) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CollectorAttribute) UnmarshalBinary(b []byte) error {
	var res CollectorAttribute
