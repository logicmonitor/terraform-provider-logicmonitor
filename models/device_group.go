...
type DeviceGroup struct {
	...
	Extra *CloudAccountExtra `json:"extra,omitempty"`
...
func (m *DeviceGroup) validateExtra(formats strfmt.Registry) error {
...
func (m *DeviceGroup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateExtra(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DeviceGroup) contextValidateExtra(ctx context.Context, formats strfmt.Registry) error {
