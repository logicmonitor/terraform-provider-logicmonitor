...
type Collector struct {
	...
	// The user's company (portal) name, this field is required if the environment variable LM_COMPANY is not set
	// Example: lm
	...
	// Read Only: true
	InstallerURLCmds interface{} `json:"installer_url_cmds,omitempty"`
	...
	// The number of instances that are monitored by this collector
	// Example: 0
	...
	// Example: 15
	ResendIval int32 `json:"resendIval"`

	// The Proxy's configuration
	// Read Only: true
	SbproxyConf string `json:"sbproxyConf,omitempty"`

	// The collector device group id assigned when creating a new collector device
	// Example: 0
...
func (m *Collector) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAcked(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Collector) validateAcked(formats strfmt.Registry) error {

	if err := validate.Required("acked", "body", bool(m.Acked)); err != nil {
		return err
	}
...
func (m *Collector) contextValidateAcked(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "acked", "body", bool(m.Acked)); err != nil {
		return err
	}
